...
std::string Fraction::lowestTerm() 
{
    ...
    else
    {
		...
		int numTemp = remainder / common;
		int denTemp = _den / common;
		return std::to_string(whole) + " " + std::to_string(numTemp) + "/" + std::to_string(denTemp);
    }
}